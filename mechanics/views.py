...
class MechanicListView(APIView):
    ...
    @extend_schema(
        operation_id="list_mechanics",
        responses=MechanicSerializer(many=True)
    )
    ...
    @extend_schema(
        operation_id="create_mechanic",
        request=MechanicSerializer,
